...
<span style="font-family:Arial sans-serif;font-size:16px;">WebApp</span>

  
<span style="font-family:Arial sans-serif;font-size:14px;">This example shows how to use planes in WEBDEV.</span>
